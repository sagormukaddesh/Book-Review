...
const Footer = () => {
    return (
        <footer className="px-4 divide-y text-white dark:bg-gray-100 bg-slate-600 mt-4 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
                           <FaBookReader size={30}className="text-green-500" ></FaBookReader>
                        </div>
                        <span className="self-center text-2xl font-semibold">Vitamin Of
                         Wisdom</span>
                    </a>
                </div>
